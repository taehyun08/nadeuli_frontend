      ...
      <div className="shop-section my-8">
        <ul className="nav gap-2" role="tablist">
          <li className="nav-item" role="presentation">
            <Link href={`/marketplace/${productId}`} className="cmn-btn alt third">
              Product Description
            </Link>
          </li>
          <li className="nav-item" role="presentation">
            <Link href={`/marketplace/${productId}/shipping`} className="cmn-btn alt third">
              Shipping
            </Link>
          </li>
          <li className="nav-item" role="presentation">
            <Link href={`/marketplace/${productId}/review`} className="cmn-btn active">
              Review
            </Link>
          </li>
          <li className="nav-item" role="presentation">
            <Link href={`/marketplace/${productId}/author`} className="cmn-btn alt third">
              Author
            </Link>
          </li>
        </ul>
      ...
      <div className="tab-content">
        <div className="customer-reviews">
          {reviewData.map((review) => {
            const { comment, title, country, date, id, img, name, rating } = review;
            return (
