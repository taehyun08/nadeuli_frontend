...
function App() {
  ...
  <Router>
    <Routes>
      {/* NadeuliPay Routes */}
      <Route path="/nadeuliPay/getNadeuliPayList/:currentPage/:tradeType/:tag" element={<NadeuliPayList />} />
      ...
      {/* Product Routes */}
      <Route path="/product/home/:currentPage/:gu" element={<ProductList />} />
      <Route path="/product/getProduct/:productId" element={<ProductDetail />} />
      <Route path="/product/updateProduct" element={<ProductUpdate />} />
      <Route path="/product/addProduct" element={<ProductAdd />} />
      <Route path="/product/getMyProductList/:tag/:currentPage" element={<MyProductList />} />
      <Route path="/product/deleteProduct/:productId" element={<ProductDelete />} />
      <Route path="/product/saleCompleted" element={<SaleCompleted />} />

      {/* Trade Routes */}
      <Route path="/trade/addTradeReview" element={<TradeReviewAdd />} />
      <Route path="/trade/updateTradeReview" element={<TradeReviewUpdate />} />
      <Route path="/trade/getTradeReviewList/:tag/:currentPage" element={<TradeReviewList />} />
      <Route path="/trade/deleteTradeReview/:tradeReviewId" element={<TradeReviewDelete />} />
      <Route path="/trade/addTradingSchedule" element={<TradeScheduleAdd />} />
      <Route path="/trade/getTradingSchedule/:tradeScheduleId" element={<TradeScheduleDetail />} />
      <Route path="/trade/updateTradingSchedule" element={<TradeScheduleUpdate />} />
      <Route path="/trade/getTradingScheduleList/:tag/:currentPage" element={<TradeScheduleList />} />

      {/* NadeuliDelivery Routes */}
