...
import '../orikkiri/myCalendar.css';
import {
    MDBBadge,
    MDBBtn,
    MDBModal,
...
const AddTradeSchedule = () => {
    ...
    const handleAddEvent = async () => {
        ...
        try {
            ...
            const buyerTag = params.buyerTag;
            const sellerTag = params.sellerTag;
            ...
            const tradeScheduleDTO = {
                tradingTime: formattedDate,
                tradingLocation: selectedAddress,
                buyer: {
                    tag: buyerTag,
                },
                seller: {
...
export default AddTradeSchedule;
